	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-hero" clsas="js-fullheight">
			<div class="flexslider js-fullheight">
				<ul class="slides">
					<li style="background-image: url(<?php echo base_url() . 'theme/images/bm4.jpg' ?>);">
						<div class="overlay-gradient"></div>
						<div class="container">
							<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
								<div class="slider-text-inner">
									<h2>We are The Best</h2>
									<p class="fh5co-lead"> CEO PT Tridaya Sinergi Indonesia <a href="http://mfikri.com/" target="_blank">Badrul Mutaqqin</a></p>
								</div>
							</div>
						</div>
					</li>
